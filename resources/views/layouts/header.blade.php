        ...
        <div class="flex justify-between h-22 items-center">
            ...
            <div class="flex items-center">
                <img src="{{ asset('alphanzoo/logo/Alfanzoo.png') }}" alt="Logo"
                    class="logo-img xxs:h-16 xms:h-20  h-full w-full sm:ml-10 mr-3 transition-all duration-300">
            ...
            <ul class="navbar-ul hidden lg:flex lg:space-x-2 xl:space-x-6 transition-all duration-300 top-0">
                <li class="relative group nav-item">
                    <a href="{{ route('home') }}">
                        <button
                            class="flex items-center justify-center  font-semibold px-3 mb-2 hover:text-[#D4A76A] focus:outline-none transition-colors duration-300">
                            Home
                        </button>
                    </a>
                </li>
                <li class="relative group">
                    <a href="{{ route('about.index') }}">
                        <button
                            class="flex items-center  font-semibold px-3 mb-2 hover:text-[#D4A76A] focus:outline-none transition-colors duration-300">
                            About Us
                        </button>
                    </a>
                </li>
                ...
                <li class="relative group">
                    <a href="{{ route('table.create') }}">
                        <button
                            class="flex items-center  font-semibold px-3 hover:text-[#D4A76A] focus:outline-none transition-colors duration-300">
                            Table Booking
                        </button>
                    </a>
                ...
                @auth
                    <li class="relative group">
                        <a href="{{ route('admin.dashboard') }}">
                            <button {{-- class="flex items-center text-xl font-bold px-3 py-0.5 hover:text-orange-400 focus:outline-none  {{ request()->routeIs('contact') ? 'text-orange-400' : '' }} " --}}
...
<div id="mobileNavbar"
    ...
    <div class="relative bg-center bg-cover h-full"
        style="background-image: url('{{ asset('images/hero/gpt.png') }}');">
        ...
        <div class="relative z-10 h-full">
            ...
            <ul class="mt-4 space-y-2">
                ...
                <li>
                    <a href="{{ route('home') }}" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">Home</a>
                </li>
                <li>
                    <a href="{{ 'about' }}" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">About Us</a>
                </li>
                ...
                <li>
                    <a href="{{ route('menu.index') }}" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">Menu</a>
                </li>

                <li>
                    <a href="{{route('rooms.index')}}" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">Rooms</a>
                </li>
                <li>
                    <a href="{{route('table.create')}}" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">Table Booking</a>
                </li>

                <li>
                    <a href="{{ route('gallery.index') }}"
                        class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">Gallery</a>
                </li>
                <li>
                    <a href="{{ route('faqs.index') }}" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">FAQs</a>
                </li>

                <li>
                    <a href=" {{ route('contact') }} " class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                        style="color: #FFF8E1 !important;">Contact</a>
                </li>
                @auth
                    <li>
                        <a href="{{ 'admin.dashboard' }}" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold"
                            style="color: #FFF8E1 !important;">Dashboard</a>
                    </li>
                @endauth
            </ul>
        </div>
            ...
            navLinks.forEach(link => {
                ...
                if (currentPath === linkPath) {
                    ...
                    if (button) {
                        ...
                        button.classList.remove('text-[#FFF8E1]', 'text-[#8B4513]',
                            'hover:text-[#D4A76A]');
