    ...
    <div class="container mx-auto max-w-2xl px-4 mt-20">
        <div class="bg-white rounded-lg shadow-lg p-8 relative">
            ...
            <form action="{{ route('faqs.store') }}" method="POST" class="space-y-6">
                ...
                <div class="mt-8">
                    <button type="submit" 
                            class="w-full bg-pastry-primary hover:bg-pastry-secondary text-white bg-blue-800 font-semibold py-3 px-4 rounded-md transition duration-150 transform hover:scale-105">
                        Create FAQ
                    </button>
                </div>
            </form>
