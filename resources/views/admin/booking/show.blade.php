                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 break-all">{{ $booking->email }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500">Phone Number</p>
                            <p class="text-lg font-semibold text-gray-900">{{ $booking->phone }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500">No. of People</p>
                            <p class="text-lg font-semibold text-gray-900">{{ $booking->no_of_people }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500">Check-In</p>
                            <p class="text-lg font-semibold text-gray-900">{{ \Carbon\Carbon::parse($booking->check_in)->format('F j, Y') }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500">Check-Out</p>
                            <p class="text-lg font-semibold text-gray-900">{{ \Carbon\Carbon::parse($booking->check_out)->format('F j, Y') }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500">Pickup Service</p>
                            <p class="text-lg font-semibold text-gray-900">
                                {{ $booking->pickup === 'yes' ? 'Yes, Required' : 'No' }}
                            </p>
                        </div>
                        @if($booking->pickup_details)
                        <div class="md:col-span-2">
                            <p class="text-sm font-medium text-gray-500">Pickup Details</p>
                            <p class="text-lg text-gray-900">{{ $booking->pickup_details }}</p>
                        </div>
                        @endif
                        @if($booking->special_request)
                        <div class="md:col-span-2">
                            <p class="text-sm font-medium text-gray-500">Special Request</p>
                            <p class="text-lg text-gray-900 whitespace-pre-line">{{ $booking->special_request }}</p>
                        </div>
                        @endif
                    </div>
                </div>
