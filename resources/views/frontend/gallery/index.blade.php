...
<div class="relative max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 mt-12">
    <div class="text-center mb-6">
        <h1 class="text-5xl italic font-bold text-pastry-primary"> Alfanzoo Gallery</h1>
        <p class="text-lg text-gray-600 mt-2">Explore our exqlusive Property</p>
    </div>
    ...
    <div class="flex flex-col sm:flex-row justify-center items-center mb-6 gap-4">
        ...
        <a href="{{ route('gallery.create') }}">
            <button class="bg-brand-brown hover:bg-amber-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-all duration-300 transform hover:scale-105 flex items-center">
...
<div class="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8 pb-12">
    @if($photos->count() > 0)
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6" id="gallery-container">
            <!-- Photo Items -->
            @foreach ($photos as $photo)
                <div class="gallery-item rounded-xl overflow-hidden shadow-lg bg-white cursor-pointer transition-all duration-300 hover:scale-[1.02] relative group">
                    ...
                    @auth
                        ...
                        <form action="{{ route('gallery.destroy', $photo->id) }}" method="POST" class="delete-btn-form">
                            @csrf @method('DELETE')
                            <button type="submit" class="delete-btn" title="Delete" onclick="return confirm('Are you sure you want to delete this photo?');">
    ...
    @else
        ...
        <div class="text-center py-16">
            ...
            <a href="{{ route('gallery.create') }}" class="bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-all duration-300">
