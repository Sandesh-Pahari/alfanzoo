...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex">
        <!-- Sidebar -->
        <aside
            class="bg-gray-800 text-white w-64 space-y-2 py-4 px-2 fixed h-full transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out z-50">
            ...
            <nav>
                ...
                <a href="{{ route('notices.list') }}"
                    class="flex items-center space-x-2 px-4 py-3 hover:bg-gray-700 rounded">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="relative">
                            <button class="flex items-center space-x-2">
                                ...
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="text-sm text-gray-700 font-bold hover:text-gray-900">
                                        Log Out
                                    </button>
                                </form>
